  ...
  <form @submit.prevent="register">
    ...
    <div class="form-group required">
      ...
      <input v-model="form.phone" type="text" id="phone" v-imask="phoneNumberMask" placeholder="+7(921)123-45-67"
        @keypress="isNumber" @accept="onAccept" @complete="onComplete" maxlength="16" />
    ...
    <div class="form-group required">
      ...
      <input v-model="form.repeatPassword" type="password" id="repeatPassword" placeholder="Повторите пароль..." />
    </div>
